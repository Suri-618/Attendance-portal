...
public class FacultyRegister {
    ...
    public FacultyRegister() {
        JFrame f = new JFrame("Register New Faculty");
        f.setSize(400, 560);
        ...
        // Title
        JLabel titleLabel = new JLabel("Faculty Registration", SwingConstants.CENTER);
        titleLabel.setFont(new Font("Segoe UI", Font.BOLD, 26));
        titleLabel.setForeground(Color.WHITE);
        titleLabel.setBounds(0, 50, 400, 40);
        mainPanel.add(titleLabel);

        JLabel subtitleLabel = new JLabel("Create a new faculty account", SwingConstants.CENTER);
        ...
        JLabel l1 = new JLabel("New Faculty ID:");
        ...
        styleTextField(facultyId);
        facultyId.setBounds(50, 235, 300, 40);
        ...
        registerBtn.addActionListener(e -> {
            ...
            try {
                ...
                PreparedStatement ps = con
                        .prepareStatement("INSERT INTO faculty (faculty_id, name, password) VALUES (?, ?, ?)");
                ...
                if (rowsInserted > 0) {
                    JOptionPane.showMessageDialog(f, "Faculty Registered Successfully!\nYou can now login.", "Success",
                            JOptionPane.INFORMATION_MESSAGE);
                    new FacultyLogin();
                    f.dispose();
                }
            } catch (java.sql.SQLIntegrityConstraintViolationException ex) {
                JOptionPane.showMessageDialog(f, "Faculty ID already exists in the database!", "Error",
