...
public class StudentLogin {
    ...
    public StudentLogin() {
        ...
        f.setSize(400, 500); // Increased height to fit register button
        ...
        JButton register = createPremiumButton("Register for New Students", new Color(0, 123, 255),
                new Color(0, 105, 217));
        ...
        login.addActionListener(e -> {
            try {
                ...
                if (con == null) {
                    JOptionPane.showMessageDialog(f, "Database Connection Failed! Is MySQL running?", "Error",
                ...
                if (rs.next()) {
                    new StudentDashboard(roll.getText());
                    f.dispose();
                } else {
